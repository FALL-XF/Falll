...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-J710F Build/MMB29K.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/SM-J710F;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Davik/2.1.0 (Linux; U; Android 9.0.0; LYA-AL10 Build/HUAWEILYA-AL10.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivoV3Max;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Dalvik/2.1.0 (Linux; U; Android 8.0; ZTE BA520 Build/MRA58K.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/ZTE BA520;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Dalvik/2.1.0 (Linux; U; Android 8.0.0; iQTAB Build/NRD90M.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/iQTAB;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
